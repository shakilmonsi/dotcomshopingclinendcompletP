...
const CatagorDetils = ({ item }) => {
    ...
    return (
     ...
     <div className=" card rounded-md bg-white shadow-md overflow-hidden	gap-row-20  " style={{width:"210px"}}>
      <div className="bg-white h-[160px]" style={{borderRadius:"24px"}}>
     <div className='' >
     ...
     <p className='text-red-500	px-8 py-1 text-xs text-centerv '>Flash Sale</p>
          </div>
